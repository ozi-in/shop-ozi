...
import H2 from "/src/components/typographies/H2";
import {
  CheckCircle,
  Truck,
  Users,
...
export const CustomText = styled(Typography)(({ theme }) => ({
 ...
 export const getTitleButton = ({title,onCLickNext,onClickPrev})=>{
   return(
 ...
 export const CustomFilledButton =({btnName,onCLick})=>{
      return(
		<Button variant="contained" color="#101828" onClick={onCLick} width="30px" height="20px"  >{btnName}</Button>
	  );
 }
...
export const SingleRowFacilityHighLight = ({items})=>{
    return (
    <Box
      display="flex"
      justifyContent="center"
