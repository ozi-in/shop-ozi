...
const AddressForm = ({
  ...
  const addAddressFormik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      try {
        // Auto-generate the address string
        const addressParts = [
          values.address_label,
          values.house,
          values.floor,
  ...
  const handleReset = () => {
    ...
    addAddressFormik.setFieldValue("house", "");
    addAddressFormik.setFieldValue("floor", "");
    addAddressFormik.setFieldValue("Apartment", "");
    //setAddressType("");
  };
        ...
        <Grid container spacing={2.8}>
          ...
          <Grid item xs={12} md={token ? "12" : "6"}>
            <CustomTextFieldWithFormik
              ...
              onChangeHandler={ApartmentHandler}
          ...
          <Grid item xs={12} sm={12} md={12} align="end">
            <FormSubmitButton
              ...
              disabled={!addAddressFormik.isValid}
              reset={t("Reset")}
              margin="8px"
              submit={
                token
