      ...
      <CustomStackFullWidth spacing={3}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6}>
            <CustomTextFieldWithFormik
              required={true}
              label={`${t("Street / Road Number")} *`}
              placeholder={t("Enter street / road")}
              touched={formik.touched.senderRoad}
              errors={formik.errors.senderRoad}
              fieldProps={formik.getFieldProps("senderRoad")}
              onChangeHandler={senderRoadHandler}
              value={formik.values.senderRoad}
              onBlur={formik.handleBlur}
              backgroundColor={
                !formik.values.senderRoad?.trim()
                  ? "rgba(255, 0, 0, 0.05)"
                  : undefined
              }
              borderColor={
                !formik.values.senderRoad?.trim() ? "#ff0000" : undefined
              }
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <CustomTextFieldWithFormik
              ...
              touched={formik.touched.senderHouse}
              errors={formik.errors.senderHouse}
              fieldProps={formik.getFieldProps("senderHouse")}
              onChangeHandler={senderHouseHandler}
              value={formik.values.senderHouse}
              onBlur={formik.handleBlur}
              backgroundColor={
                !formik.values.senderHouse?.trim()
                  ? "rgba(255, 0, 0, 0.05)"
                  : undefined
              }
              borderColor={
                !formik.values.senderHouse?.trim() ? "#ff0000" : undefined
              }
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <CustomTextFieldWithFormik
              ...
              touched={formik.touched.senderFloor}
              errors={formik.errors.senderFloor}
              fieldProps={formik.getFieldProps("senderFloor")}
              onChangeHandler={senderFloorHandler}
              value={formik.values.senderFloor}
              onBlur={formik.handleBlur}
              backgroundColor={
                !formik.values.senderFloor?.trim()
                  ? "rgba(255, 0, 0, 0.05)"
                  : undefined
              }
              borderColor={
                !formik.values.senderFloor?.trim() ? "#ff0000" : undefined
              }
            />
          </Grid>
        </Grid>
