...
//     return (
//       <Box sx={{ width: "100%", bgcolor: "#fff", boxShadow: 1, py: 1.5 }}>
...
//             sx={{ minWidth: 0 }}
//           >
//             <LogoSide width="1500px" height="65px" configData={configData} />
//             <Divider
//               orientation="vertical"
//               flexItem
//               sx={{ mx: 1, height: 40, borderColor: "#E0E0E0" }}
//             />
//             {location && (
//               <Stack
//                 direction="column"
...
// //     return (
// //       <Box
// //         sx={{ width: "100%", bgcolor: "#fff", boxShadow: 1, px: 4, py: 1.5 }}
// //       >
// //         {/* Grid layout for perfect alignment */}
// //         <Box
// //           sx={{
        ...
        >
          ...
          >
            <Box
              ...
              src={Logo.src}
              alt="logo"
              sx={{ objectFit: "contain", width: "25%", py: 1 }}
            />
